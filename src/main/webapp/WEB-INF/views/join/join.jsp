...
<body>
	...
	<form action="<c:url value="joinSuccess"/>" method="post" name="joinForm" onsubmit="return joinCheck()">
		<input type="text" name="memId" placeholder="아이디를 입력해주세요" maxlength="10" autofocus required/> <input type="button" value="아이디 중복확인" onclick="idCheck(this.form.memId.value)"><br>
